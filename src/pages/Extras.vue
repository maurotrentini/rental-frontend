<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Extras</h1>
        <p class="text-gray-600 dark:text-gray-300">Manage additional services and add-ons</p>
      </div>
    ...
    <div v-else-if="extraStore.extras.length === 0" class="text-center py-12">
      ...
      <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No extras</h3>
      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a new extra service.</p>
      <div class="mt-6">
        <router-link to="/extras/create" class="btn btn-primary">
          Add Extra
        </router-link>
    ...
    <div v-if="showDeleteModal" class="fixed inset-0 bg-gray-600 dark:bg-gray-900 bg-opacity-50 dark:bg-opacity-75 overflow-y-auto h-full w-full z-50">
      <div class="relative top-20 mx-auto p-5 border border-gray-200 dark:border-gray-700 w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <div class="mt-3 text-center">
          <h3 class="text-lg font-medium text-gray-900 dark:text-white">Delete Extra</h3>
